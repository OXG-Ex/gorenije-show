        ...
        <Paper elevation={4} className="p-8 ">
          <div className="flex flex-col gap-7">
            ...
            <Typography variant="body1">
              Мы большая команда артистов,пиротехников и техников. За 15 лет мы
              провели более 500 огненных и пиротехнических шоу.
            </Typography>
            <Typography>
              ...
              праздничными агентствами. Вам не нужно ни о чем беспокоиться, ведь
